...
const WORLD_GEOJSON_HREF = "/arrivals-preview-assets/preview/world.geojson?v=20260219-solari50";
const WORLD_SVG_FALLBACK_HREF = "/arrivals-preview-assets/preview/world.svg?v=20260219-solari50";
const PLANE_IMAGE_HREF = "/arrivals-preview-assets/preview/plane.svg?v=20260219-solari50";
const BEIJING_ICON_HREF = "/arrivals-preview-assets/preview/beijing-icon.png?v=20260219-solari79";
...
async function fetchPreviewData() {
  const response = await fetch("/api/arrivals-preview/mock", { cache: "no-store" });
  if (!response.ok) {
  ...
  if (!payload || !payload.ok || !payload.data) {
    throw new Error("Preview API returned invalid payload");
  }
